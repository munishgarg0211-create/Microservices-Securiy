# ch13 - Regulatory Requirements Mapping
...
## Objective
Map GDPR/HIPAA/PCI controls to architecture.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch13-regulation-control-matrix";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Map GDPR/HIPAA/PCI controls to architecture.";
    private static final String CONCEPT = "Regulation Control Matrix";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch13-regulation-control-matrix"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_regulation_control_matrix/DemoServiceTest.java`
