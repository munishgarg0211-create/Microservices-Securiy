...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch14-ethical-risk-checklist",
                "book", "book-3-advanced-patterns",
                "status", "sample-ready",
