# ch14 - Ethical and Societal Controls
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch14-ethical-risk-checklist";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Privacy and ethics decision checklist.";
    private static final String CONCEPT = "Ethical Risk Checklist";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch14-ethical-risk-checklist"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_ethical_risk_checklist/DemoServiceTest.java`
