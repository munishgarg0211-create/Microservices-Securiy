...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_data_residency_router/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_data_residency_router/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.
...
public class DemoService {
    ...
    private static final String PROJECT = "ch13-data-residency-router";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Geo-sharding router with privacy controls.";
    private static final String CONCEPT = "Data Residency Router";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_data_residency_router/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch13-data-residency-router"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_data_residency_router/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch13-data-residency-router", result.get("project"));
