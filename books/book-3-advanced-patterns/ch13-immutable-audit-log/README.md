...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch13-immutable-audit-log";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Tamper-evident audit log implementation.";
    private static final String CONCEPT = "Immutable Audit Log";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoServiceTest.java`
