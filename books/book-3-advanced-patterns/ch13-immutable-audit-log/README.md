...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_immutable_audit_log/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch13-immutable-audit-log",
                "book", "book-3-advanced-patterns",
                "status", "sample-ready",
