...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoServiceTest.java`: Automated check that validates expected secure behavior.
