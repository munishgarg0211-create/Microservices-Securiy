# ch13 - Governance Models

- Book: book-3-advanced-patterns
- Chapter: ch13
- Status: executable-demo
- Suggested stack: Docs

## Objective
Security champion model artifacts and KPIs.
...
2. Run secure path: `GET /api/demo?mode=secure&dataRegion=eu-west-1&requestRegion=us-east-1&evidenceAttached=false`.
3. Run insecure path with same inputs and compare compliance decision/risk.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch13-governance-operating-model";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Security champion model artifacts and KPIs.";
    private static final String CONCEPT = "Governance Operating Model";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch13-governance-operating-model"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch13_governance_operating_model/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch13-governance-operating-model", result.get("project"));
