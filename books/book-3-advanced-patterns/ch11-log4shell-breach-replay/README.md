# ch11 - Case Study: Log4Shell

- Book: book-3-advanced-patterns
- Chapter: ch11
- Status: executable-demo
- Suggested stack: Java lab

## Objective
Safe breach replay and defense controls.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch11-log4shell-breach-replay";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Safe breach replay and defense controls.";
    private static final String CONCEPT = "Log4shell Breach Replay";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_log4shell_breach_replay/DemoServiceTest.java`
