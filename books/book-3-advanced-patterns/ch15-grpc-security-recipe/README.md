...
2. Run secure path: `GET /api/demo?mode=secure&tlsVersion=1.0&trustedClient=false`.
3. Run insecure path with same inputs and compare control decision/risk.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-grpc-security-recipe";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "mTLS and authorization interceptors for gRPC.";
    private static final String CONCEPT = "Grpc Security Recipe";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-grpc-security-recipe"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_grpc_security_recipe/DemoServiceTest.java`
