# ch12 - Security as Design Concern

- Book: book-3-advanced-patterns
- Chapter: ch12
- Status: executable-demo
- Suggested stack: ADR templates

## Objective
Security-focused architecture decision records.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoService.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch12-security-first-adr"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_security_first_adr/DemoServiceTest.java`
