...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch11-capitalone-ssrf-lab";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "SSRF chain and IAM hardening demo.";
    private static final String CONCEPT = "Capitalone Ssrf Lab";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch11-capitalone-ssrf-lab"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoServiceTest.java`
