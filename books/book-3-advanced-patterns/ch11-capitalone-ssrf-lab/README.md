...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_capitalone_ssrf_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch11-capitalone-ssrf-lab",
                "book", "book-3-advanced-patterns",
                "status", "sample-ready",
