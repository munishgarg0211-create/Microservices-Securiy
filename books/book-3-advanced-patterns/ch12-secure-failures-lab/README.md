# ch12 - Fault Tolerance and Secure Failures

- Book: book-3-advanced-patterns
- Chapter: ch12
- Status: executable-demo
- Suggested stack: Resilience4j

## Objective
Fail-closed patterns with resilience.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch12-secure-failures-lab";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Fail-closed patterns with resilience.";
    private static final String CONCEPT = "Secure Failures Lab";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch12-secure-failures-lab"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_failures_lab/DemoServiceTest.java`
