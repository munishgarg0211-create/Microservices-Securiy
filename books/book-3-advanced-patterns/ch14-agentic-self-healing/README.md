...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch14-agentic-self-healing";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Automated policy rollback with safeguards.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch14-agentic-self-healing"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoServiceTest.java`
