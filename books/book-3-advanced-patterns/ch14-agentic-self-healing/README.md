...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_agentic_self_healing/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch14-agentic-self-healing",
                "book", "book-3-advanced-patterns",
                "status", "sample-ready",
