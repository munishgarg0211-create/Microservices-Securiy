# ch14 - AI-Driven Security Tooling
...
## Objective
AI-assisted anomaly triage with human approval.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch14-ai-security-triage";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "AI-assisted anomaly triage with human approval.";
    private static final String CONCEPT = "Ai Security Triage";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch14-ai-security-triage"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_ai_security_triage/DemoServiceTest.java`
