...
## Objective
Gateway BFF auth flow with session cookie.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-oauth2-bff-flow";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Gateway BFF auth flow with session cookie.";
    private static final String CONCEPT = "Oauth2 Bff Flow";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-oauth2-bff-flow"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_oauth2_bff_flow/DemoServiceTest.java`
