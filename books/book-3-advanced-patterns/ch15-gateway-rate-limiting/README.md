...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-gateway-rate-limiting";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Per-user token-aware rate limiting.";
    private static final String CONCEPT = "Gateway Rate Limiting";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-gateway-rate-limiting"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoServiceTest.java`
