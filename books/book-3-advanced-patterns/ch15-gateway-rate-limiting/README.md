...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_gateway_rate_limiting/DemoServiceTest.java`: Automated check that validates expected secure behavior.
