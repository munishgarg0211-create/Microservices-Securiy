...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch12-privilege-segregation-demo";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Split-plane privilege boundaries across layers.";
    private static final String CONCEPT = "Privilege Segregation Demo";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch12-privilege-segregation-demo"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoServiceTest.java`
