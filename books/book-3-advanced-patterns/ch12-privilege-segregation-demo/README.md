...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_privilege_segregation_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior.
