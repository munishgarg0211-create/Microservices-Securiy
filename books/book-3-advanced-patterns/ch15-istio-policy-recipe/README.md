...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_istio_policy_recipe/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_istio_policy_recipe/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-istio-policy-recipe";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "mTLS and authz policy manifests.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_istio_policy_recipe/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-istio-policy-recipe"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_istio_policy_recipe/DemoServiceTest.java`
