# ch12 - Zero Trust in Microservices

- Book: book-3-advanced-patterns
- Chapter: ch12
- Status: executable-demo
- Suggested stack: SPIFFE/SPIRE

## Objective
Workload identity and trust policy baseline.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch12-zero-trust-reference";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Workload identity and trust policy baseline.";
    private static final String CONCEPT = "Zero Trust Reference";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch12-zero-trust-reference"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_zero_trust_reference/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch12-zero-trust-reference", result.get("project"));
