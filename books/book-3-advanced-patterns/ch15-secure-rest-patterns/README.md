# ch15 - Recipe: Secure REST API Patterns

- Book: book-3-advanced-patterns
- Chapter: ch15
- Status: executable-demo
- Suggested stack: Spring Boot
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_secure_rest_patterns/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_secure_rest_patterns/DemoController.java`

```java
package com.munishgarg.microsecurity.book3.ch15_secure_rest_patterns;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_secure_rest_patterns/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-secure-rest-patterns";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_secure_rest_patterns/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-secure-rest-patterns"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_secure_rest_patterns/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch15-secure-rest-patterns", result.get("project"));
