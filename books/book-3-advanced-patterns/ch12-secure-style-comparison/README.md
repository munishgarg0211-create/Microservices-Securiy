# ch12 - Secure Architecture Styles

- Book: book-3-advanced-patterns
- Chapter: ch12
- Status: executable-demo
- Suggested stack: Java + Kafka

## Objective
Compare hexagonal and event-driven security.
...
2. Run secure path: `GET /api/demo?mode=secure`.
3. Run insecure path: `GET /api/demo?mode=insecure` and compare impact fields.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch12-secure-style-comparison";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Compare hexagonal and event-driven security.";
    private static final String CONCEPT = "Secure Style Comparison";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch12-secure-style-comparison"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch12_secure_style_comparison/DemoServiceTest.java`
