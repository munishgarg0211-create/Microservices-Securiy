# ch15 - Recipe: JWT Filter and Role Checks

- Book: book-3-advanced-patterns
- Chapter: ch15
- Status: executable-demo
- Suggested stack: Spring Security

## Objective
Implement JWT parsing, role extraction, and guards.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-jwt-filter-role-checks";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Implement JWT parsing, role extraction, and guards.";
    private static final String CONCEPT = "Jwt Filter Role Checks";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-jwt-filter-role-checks"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_jwt_filter_role_checks/DemoServiceTest.java`
