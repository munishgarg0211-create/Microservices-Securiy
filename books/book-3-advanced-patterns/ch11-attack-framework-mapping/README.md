...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch11-attack-framework-mapping",
                "book", "book-3-advanced-patterns",
                "status", "sample-ready",
