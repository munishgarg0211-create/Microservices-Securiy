...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch11-attack-framework-mapping";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Map ATT&CK/Kill Chain to controls.";
    private static final String CONCEPT = "Attack Framework Mapping";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch11-attack-framework-mapping"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_attack_framework_mapping/DemoServiceTest.java`
