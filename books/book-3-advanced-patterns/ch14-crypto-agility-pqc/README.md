# ch14 - Quantum-Resistant Preparedness

- Book: book-3-advanced-patterns
- Chapter: ch14
- Status: executable-demo
- Suggested stack: Java crypto

## Objective
Crypto-agility abstraction and migration path.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch14-crypto-agility-pqc";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Crypto-agility abstraction and migration path.";
    private static final String CONCEPT = "Crypto Agility Pqc";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch14-crypto-agility-pqc"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_crypto_agility_pqc/DemoServiceTest.java`
