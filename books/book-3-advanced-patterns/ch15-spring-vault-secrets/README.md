# ch15 - Recipe: Secret Injection with Vault

- Book: book-3-advanced-patterns
- Chapter: ch15
- Status: executable-demo
- Suggested stack: Spring Vault
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-spring-vault-secrets";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Runtime secret injection from Vault.";
    private static final String CONCEPT = "Spring Vault Secrets";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch15-spring-vault-secrets"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoServiceTest.java`
