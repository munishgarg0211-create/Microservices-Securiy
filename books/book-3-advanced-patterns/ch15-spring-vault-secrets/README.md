...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_spring_vault_secrets/DemoServiceTest.java`: Automated check that validates expected secure behavior.
