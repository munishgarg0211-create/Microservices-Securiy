# ch14 - Federated Identity

- Book: book-3-advanced-patterns
- Chapter: ch14
- Status: executable-demo
- Suggested stack: OIDC/SAML

## Objective
Cross-cloud identity federation demo.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch14-federated-identity-multicloud";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Cross-cloud identity federation demo.";
    private static final String CONCEPT = "Federated Identity Multicloud";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch14-federated-identity-multicloud"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch14_federated_identity_multicloud/DemoServiceTest.java`
