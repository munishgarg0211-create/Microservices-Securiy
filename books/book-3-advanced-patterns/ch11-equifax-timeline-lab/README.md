# ch11 - Case Study: Equifax Timeline

- Book: book-3-advanced-patterns
- Chapter: ch11
- Status: executable-demo
- Suggested stack: Docs + scripts

## Objective
Patch-lag and exploit timeline simulation.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch11-equifax-timeline-lab";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "Patch-lag and exploit timeline simulation.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch11-equifax-timeline-lab"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch11_equifax_timeline_lab/DemoServiceTest.java`
