# ch15 - Recipe: Kubernetes Security Contexts
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch15-k8s-security-contexts";
    private static final String BOOK = "book-3-advanced-patterns";
    private static final String OBJECTIVE = "RunAsNonRoot and restricted context examples.";
    private static final String CONCEPT = "K8s Security Contexts";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book3/ch15_k8s_security_contexts/DemoServiceTest.java`
