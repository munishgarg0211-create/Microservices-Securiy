...
public class DemoService {
    ...
    private static final String PROJECT = "ch10-centralized-enriched-logs";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Structured logs with user/trace enrichment.";
    private static final String CONCEPT = "Centralized Enriched Logs";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch10_centralized_enriched_logs/DemoControllerTest.java`
