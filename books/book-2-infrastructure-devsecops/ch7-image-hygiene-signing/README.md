...
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoServiceTest.java`: Automated check that validates expected secure behavior.
