# ch7 - Docker Image Hygiene and Signing

- Book: book-2-infrastructure-devsecops
- Chapter: ch7
- Status: executable-demo
- Suggested stack: Trivy, Cosign

## Objective
Image scanning and signature verification gates.

## Security Context

### The Problem
Unverified base images pulled from public registries often contain critical CVEs, embedded malware, or misconfigured defaults, silently compromising the workload before it even runs.

### The Resolution
Integrating strict image hygiene and cryptographic signing enforces a trusted software supply chain. Only distroless, minimally-configured images that carry verified cryptographic signatures are permitted to execute in the cluster.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch7-image-hygiene-signing";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch7-image-hygiene-signing"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_image_hygiene_signing/DemoServiceTest.java`
