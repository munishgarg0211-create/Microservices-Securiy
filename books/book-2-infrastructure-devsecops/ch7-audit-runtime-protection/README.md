# ch7 - Auditability and Runtime Protections

- Book: book-2-infrastructure-devsecops
- Chapter: ch7
- Status: executable-demo
- Suggested stack: Falco, Audit logs

## Objective
Falco runtime detection with audit trails.

## Security Context

### The Problem
Without runtime system call monitoring, attackers who exploit an application vulnerability can gain arbitrary code execution, spawn unauthorized shells, or tamper with system files undetected.

### The Resolution
Deploying runtime protection continuously profiles container behavior at the kernel level. Any unexpected syscall or anomalous execution triggers an immediate alert and audit event, effectively neutralizing zero-day exploitation attempts.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch7-audit-runtime-protection";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Falco runtime detection with audit trails.";
    private static final String CONCEPT = "Audit Runtime Protection";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch7-audit-runtime-protection"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_audit_runtime_protection/DemoServiceTest.java`
