# ch7 - Secrets and Pod Security

- Book: book-2-infrastructure-devsecops
- Chapter: ch7
- Status: executable-demo
- Suggested stack: Vault, PSA

## Objective
Vault-backed secrets with pod security controls.

## Security Context

### The Problem
Hardcoding credentials or mounting secrets insecurely exposes highly sensitive API keys and database passwords to unauthorized users, memory dumps, or container escape vulnerabilities.

### The Resolution
Leveraging robust pod security standards alongside external secret managers cleanly isolates credentials. Sensitive data is injected securely at runtime without ever persisting to disk or exposing underlying nodes.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoController.java`

```java
package com.munishgarg.microsecurity.book2.ch7_secrets_pod_security;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch7-secrets-pod-security";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Vault-backed secrets with pod security controls.";
    private static final String CONCEPT = "Secrets Pod Security";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch7-secrets-pod-security"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch7_secrets_pod_security/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch7-secrets-pod-security", result.get("project"));
