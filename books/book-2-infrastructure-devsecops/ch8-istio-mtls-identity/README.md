...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_mtls_identity/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_mtls_identity/DemoServiceTest.java`: Automated check that validates expected secure behavior.
