# ch9 - Secrets and Supply Chain Validation

- Book: book-2-infrastructure-devsecops
- Chapter: ch9
- Status: executable-demo
- Suggested stack: Gitleaks, Syft

## Objective
Secret scanning and SBOM verification gates.

## Security Context

### The Problem
Hardcoded secrets in code repositories and opaque third-party dependencies are major attack vectors, leading to devastating supply chain compromises and data breaches.

### The Resolution
Enforcing automated secret scanning prevents credential leaks, while generating Software Bill of Materials (SBOMs) provides full visibility into the dependency tree to rapidly identify and patch vulnerable open-source components.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoController.java`

```java
package com.munishgarg.microsecurity.book2.ch9_secrets_sbom_supplychain;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch9-secrets-sbom-supplychain";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Secret scanning and SBOM verification gates.";
    private static final String CONCEPT = "Secrets Sbom Supplychain";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch9-secrets-sbom-supplychain"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch9-secrets-sbom-supplychain", result.get("project"));
