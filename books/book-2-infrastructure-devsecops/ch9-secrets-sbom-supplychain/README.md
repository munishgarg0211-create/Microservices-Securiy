...
2. Run secure path: `GET /api/demo?mode=secure&imageSigned=false&hasSbom=false&criticalVulns=2`.
3. Run insecure path with same inputs and compare policy-gate impact.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_secrets_sbom_supplychain/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.
