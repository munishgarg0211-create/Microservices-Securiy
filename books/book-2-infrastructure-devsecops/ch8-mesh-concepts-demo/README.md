...
## Objective
Data/control plane demo with sidecars.

## Security Context

### The Problem
Implementing disjointed, framework-specific security controls inside individual application codebases leads to inconsistent enforcement, rapid technical debt, and frequent vulnerability regressions.

### The Resolution
Decoupling security from the application layer and offloading routing, encryption, and authorization directly to an infrastructure-wide Service Mesh ensures uniform, irrefutable policy compliance universally.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch8-mesh-concepts-demo";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Data/control plane demo with sidecars.";
    private static final String CONCEPT = "Mesh Concepts Demo";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch8-mesh-concepts-demo"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoServiceTest.java`
