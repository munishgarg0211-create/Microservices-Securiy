...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_concepts_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch8-mesh-concepts-demo",
                "book", "book-2-infrastructure-devsecops",
                "status", "sample-ready",
