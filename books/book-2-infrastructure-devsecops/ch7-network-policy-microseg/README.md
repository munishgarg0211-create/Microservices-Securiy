...
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_network_policy_microseg/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch7_network_policy_microseg/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch7-network-policy-microseg",
                "book", "book-2-infrastructure-devsecops",
                "status", "sample-ready",
