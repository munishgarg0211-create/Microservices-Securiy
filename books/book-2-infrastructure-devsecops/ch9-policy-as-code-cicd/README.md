...
- Suggested stack: OPA, Kyverno

## Objective
OPA/Kyverno checks in pipeline.

## Security Context

### The Problem
Relying on wiki pages and manual checks for security policies leads to inconsistent enforcement, human error, and compliance drift in production environments.

### The Resolution
Defining Policy-as-Code (PaC) allows security rules to be treated like software. Policies are enforced automatically by the pipeline, blocking non-compliant infrastructure or code from reaching production.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoController.java`

```java
package com.munishgarg.microsecurity.book2.ch9_policy_as_code_cicd;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch9-policy-as-code-cicd";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "OPA/Kyverno checks in pipeline.";
    private static final String CONCEPT = "Policy As Code Cicd";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch9-policy-as-code-cicd"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_policy_as_code_cicd/DemoServiceTest.java`
