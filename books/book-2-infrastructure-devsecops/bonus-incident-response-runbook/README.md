...
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoServiceTest.java`: Automated check that validates expected secure behavior.
