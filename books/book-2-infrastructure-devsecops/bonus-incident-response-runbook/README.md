...
- Suggested stack: Markdown, scripts
...
2. Run secure path: `GET /api/demo?mode=secure&incidents=3`.
3. Run insecure path with same inputs and compare MTTR and response posture.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "bonus-incident-response-runbook";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Tabletop drill and incident SOP assets.";
    private static final String CONCEPT = "Incident Response Runbook";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("bonus-incident-response-runbook"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_incident_response_runbook/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("bonus-incident-response-runbook", result.get("project"));
