# ch9 - DevSecOps Principles

- Book: book-2-infrastructure-devsecops
- Chapter: ch9
- Status: executable-demo
- Suggested stack: GitHub Actions

## Objective
Secure-by-default repository and workflow template.

## Security Context

### The Problem
Manual security reviews and gatekeeping slow down delivery pipelines and often miss hidden vulnerabilities in fast-moving microservice deployments.

### The Resolution
Embedding security natively into the CI/CD pipeline automates verification. DevSecOps ensures that every commit is continuously evaluated against security baselines without human bottlenecks.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoController.java`

```java
package com.munishgarg.microsecurity.book2.ch9_devsecops_template;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch9-devsecops-template";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Secure-by-default repository and workflow template.";
    private static final String CONCEPT = "Devsecops Template";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch9-devsecops-template"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_devsecops_template/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch9-devsecops-template", result.get("project"));
