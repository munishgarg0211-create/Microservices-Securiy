# bonus - Observability Setup Guide

- Book: book-2-infrastructure-devsecops
- Chapter: bonus
- Status: scaffolded
- Suggested stack: Prometheus stack
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoController.java`

```java
package com.munishgarg.microsecurity.book2.bonus_observability_stack_guide;
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "bonus-observability-stack-guide";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Deploy baseline observability for security.";
    private static final String CONCEPT = "Observability Stack Guide";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("bonus-observability-stack-guide"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_observability_stack_guide/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("bonus-observability-stack-guide", result.get("project"));
