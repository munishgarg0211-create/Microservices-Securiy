# bonus - Production Deployment Checklist

- Book: book-2-infrastructure-devsecops
- Chapter: bonus
- Status: executable-demo
- Suggested stack: Shell, CI

## Objective
Automated deployment security gate checks.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "bonus-prod-deployment-gates";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Automated deployment security gate checks.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("bonus-prod-deployment-gates"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_prod_deployment_gates/DemoServiceTest.java`
