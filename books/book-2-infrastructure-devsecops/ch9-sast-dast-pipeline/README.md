...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoServiceTest.java`: Automated check that validates expected secure behavior.
