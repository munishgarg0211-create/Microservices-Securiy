# ch9 - Static and Dynamic Analysis

- Book: book-2-infrastructure-devsecops
- Chapter: ch9
- Status: executable-demo
- Suggested stack: Semgrep, ZAP

## Objective
SAST + DAST integrated CI stages.

## Security Context

### The Problem
Deploying untested code exposes applications to common OWASP vulnerabilities like injection and cross-site scripting, which are easily missed by standard unit tests.

### The Resolution
Integrating Static Application Security Testing (SAST) and Dynamic Application Security Testing (DAST) into the pipeline automatically scans the codebase and running application for vulnerabilities, failing the build if critical flaws are found.
...
2. Run API endpoint: `GET /api/demo`.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch9-sast-dast-pipeline";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "SAST + DAST integrated CI stages.";
    private static final String CONCEPT = "Sast Dast Pipeline";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch9-sast-dast-pipeline"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_sast_dast_pipeline/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch9-sast-dast-pipeline", result.get("project"));
