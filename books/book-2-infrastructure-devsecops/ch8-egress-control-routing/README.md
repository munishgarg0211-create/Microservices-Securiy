# ch8 - Egress Control and Routing

- Book: book-2-infrastructure-devsecops
- Chapter: ch8
- Status: executable-demo
- Suggested stack: Istio Egress

## Objective
Restrict egress and permit allowlisted destinations.

## Security Context

### The Problem
Unrestricted outbound traffic allows compromised services to effortlessly exfiltrate data, download malicious payloads, or establish C2 connections to adversary networks.

### The Resolution
Applying strict egress control policies forces a default-deny posture. Only explicitly allowlisted, business-approved external endpoints are reachable, minimizing the attacker's blast radius.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoService.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch8-egress-control-routing"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_egress_control_routing/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch8-egress-control-routing", result.get("project"));
