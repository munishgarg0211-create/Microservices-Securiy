...
### The Problem
Operating microservices blindly without unified telemetry leaves security operations unable to detect policy violations, debug transit failures, or identify stealthy active intrusions promptly.

### The Resolution
Enforcing mesh-native observability continuously exports structured metrics, unified traces, and access logs securely to central monitoring, enabling immediate incident detection without trusting the application.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch8-mesh-observability-enforcement";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Trace and verify policy enforcement events.";
    private static final String CONCEPT = "Mesh Observability Enforcement";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch8-mesh-observability-enforcement"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_mesh_observability_enforcement/DemoServiceTest.java`
