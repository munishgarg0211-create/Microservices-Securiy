# ch10 - Behavioral Anomaly Detection

- Book: book-2-infrastructure-devsecops
- Chapter: ch10
- Status: executable-demo
- Suggested stack: Python, Prometheus

## Objective
Baseline behavior model and anomaly alerts.

## Security Context

### The Problem
Traditional signature-based detection models fail to recognize entirely new attack patterns or zero-day exploits that lack known indicators of compromise.

### The Resolution
Deploying machine-learning anomaly detection establishes a behavioral baseline for the cluster. The system can independently identify and block highly suspicious activity deviations without requiring pre-written rules.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch10-anomaly-detection-lab";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Baseline behavior model and anomaly alerts.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch10-anomaly-detection-lab"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch10_anomaly_detection_lab/DemoServiceTest.java`
