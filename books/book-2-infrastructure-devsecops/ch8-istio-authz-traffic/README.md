...
## Objective
Service-to-service authZ policies in mesh.

## Security Context

### The Problem
Implicit lateral trust within a cluster allows an attacker who compromises a low-priority pod to traverse the network freely and attack highly sensitive backend databases or critical services.

### The Resolution
Implementing fine-grained Layer 7 authorization rules (like Istio AuthZ) establishes Zero-Trust boundaries. Internal traffic is authenticated and explicitly authorized per request path, preventing lateral movement.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch8-istio-authz-traffic";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Service-to-service authZ policies in mesh.";
    private static final String CONCEPT = "Istio Authz Traffic";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch8-istio-authz-traffic"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch8-istio-authz-traffic", result.get("project"));
