...
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book2/ch8_istio_authz_traffic/DemoServiceTest.java`: Automated check that validates expected secure behavior.
