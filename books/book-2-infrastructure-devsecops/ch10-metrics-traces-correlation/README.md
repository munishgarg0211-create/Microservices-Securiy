# ch10 - Correlation Analysis

- Book: book-2-infrastructure-devsecops
- Chapter: ch10
- Status: executable-demo
- Suggested stack: OpenTelemetry

## Objective
Link metrics, traces, and logs for incidents.

## Security Context

### The Problem
Investigating an incident using isolated metric dashboards and disconnected trace data results in massive blind spots and wildly inaccurate root-cause analysis during high-stress breaches.

### The Resolution
Correlating security metrics directly with distributed request traces binds performance symptoms to specific intrusion vectors, perfectly isolating the exact network and application path an attacker exploited.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch10-metrics-traces-correlation";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Link metrics, traces, and logs for incidents.";
    private static final String CONCEPT = "Metrics Traces Correlation";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch10_metrics_traces_correlation/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch10-metrics-traces-correlation", result.get("project"));
