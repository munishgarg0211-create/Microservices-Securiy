...
### The Problem
Designing microservices without formal threat modeling leads to systemic architectural flaws, missing security controls, and costly late-stage remediations.

### The Resolution
Integrating an agile, developer-centric threat model directly into the design phase ensures security is baked in early. Controls are mapped directly to identified STRIDE threats before code is written.
...
2. Run API endpoint: `GET /api/demo?exploitability=80&controlCoverage=85`.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoApplication.java`: Spring Boot entrypoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoController.java`: Unified security endpoint.
- `src/main/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoService.java`: Secure-by-default logic.
...
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoControllerTest.java`: Automated validation of the security endpoint.
- `src/test/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoServiceTest.java`: Logic validation for deterministic outcomes.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch9-agile-threat-model-lite";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "PR-integrated lightweight threat model process.";
    private static final String CONCEPT = "Agile Threat Model Lite";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch9-agile-threat-model-lite"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/ch9_agile_threat_model_lite/DemoServiceTest.java`
