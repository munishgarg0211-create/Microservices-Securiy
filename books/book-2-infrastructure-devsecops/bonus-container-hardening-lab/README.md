# bonus - Container Hardening Checklist

- Book: book-2-infrastructure-devsecops
- Chapter: bonus
- Status: executable-demo
- Suggested stack: Docker

## Objective
Distroless hardening and runtime restrictions.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "bonus-container-hardening-lab";
    private static final String BOOK = "book-2-infrastructure-devsecops";
    private static final String OBJECTIVE = "Distroless hardening and runtime restrictions.";
    private static final String CONCEPT = "Container Hardening Lab";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("bonus-container-hardening-lab"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book2/bonus_container_hardening_lab/DemoServiceTest.java`
