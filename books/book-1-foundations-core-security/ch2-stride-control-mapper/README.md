# ch2 - Threat to Control Mapping

- Book: book-1-foundations-core-security
- Chapter: ch2
- Status: executable-demo
- Suggested stack: Markdown, templates

## Objective
Map STRIDE threats to defense controls.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Map STRIDE threats to defense controls.";
    private static final String CONCEPT = "Stride Control Mapper";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch2-stride-control-mapper"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_stride_control_mapper/DemoServiceTest.java`
