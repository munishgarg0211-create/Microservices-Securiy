...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_protocol_threat_comparison/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_protocol_threat_comparison/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Compare HTTP/gRPC/Kafka threat patterns.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_protocol_threat_comparison/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_protocol_threat_comparison/DemoServiceTest.java`
