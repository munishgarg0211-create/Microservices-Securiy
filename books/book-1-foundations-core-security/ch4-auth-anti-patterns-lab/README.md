...
## Objective
Demonstrate common token/auth pitfalls.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch4-auth-anti-patterns-lab";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Demonstrate common token/auth pitfalls.";
    private static final String CONCEPT = "Auth Anti Patterns Lab";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_auth_anti_patterns_lab/DemoServiceTest.java`
