...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Threat model comparing monolith vs distributed architecture.";
    private static final String CONCEPT = "Security Shift Modeling";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoServiceTest.java`
