...
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_security_shift_modeling/DemoServiceTest.java`: Automated check that validates expected secure behavior.
