# ch2 - OWASP in Microservices

- Book: book-1-foundations-core-security
- Chapter: ch2
- Status: executable-demo
- Suggested stack: Spring Boot, JUnit

## Objective
Demonstrate BOLA and mitigation in service endpoints.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Demonstrate BOLA and mitigation in service endpoints.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_owasp_bola_lab/DemoServiceTest.java`
