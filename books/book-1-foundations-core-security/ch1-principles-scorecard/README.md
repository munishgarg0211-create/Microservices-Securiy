...
- Suggested stack: OPA, Conftest

## Objective
Enforce least privilege and secure defaults checks.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Enforce least privilege and secure defaults checks.";
    private static final String CONCEPT = "Principles Scorecard";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_principles_scorecard/DemoServiceTest.java`
