# ch5 - Request Validation at Edge

- Book: book-1-foundations-core-security
- Chapter: ch5
- Status: executable-demo
- Suggested stack: Gateway + JSON Schema

## Objective
OpenAPI schema and header validation at gateway.
...
2. Run secure path: `GET /api/demo?mode=secure&requests=120&limit=100` and verify throttling.
3. Run insecure path with same inputs and compare blocked vs allowed counts.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-request-validation-edge";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "OpenAPI schema and header validation at gateway.";
    private static final String CONCEPT = "Request Validation Edge";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-request-validation-edge"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_request_validation_edge/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch5-request-validation-edge", result.get("project"));
