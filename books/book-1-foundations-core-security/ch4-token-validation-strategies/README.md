# ch4 - Distributed Token Validation

- Book: book-1-foundations-core-security
- Chapter: ch4
- Status: executable-demo
- Suggested stack: Redis, Spring

## Objective
Compare introspection vs local validation.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch4-token-validation-strategies";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Compare introspection vs local validation.";
    private static final String CONCEPT = "Token Validation Strategies";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch4-token-validation-strategies"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_token_validation_strategies/DemoServiceTest.java`
