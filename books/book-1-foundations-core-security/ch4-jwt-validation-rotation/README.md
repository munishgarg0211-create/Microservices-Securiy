...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoServiceTest.java`: Automated check that validates expected secure behavior.
