...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoService.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch4-jwt-validation-rotation"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_jwt_validation_rotation/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch4-jwt-validation-rotation", result.get("project"));
