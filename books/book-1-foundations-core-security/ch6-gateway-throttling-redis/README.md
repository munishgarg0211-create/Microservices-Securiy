...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Distributed throttling with Redis.";
    private static final String CONCEPT = "Gateway Throttling Redis";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_gateway_throttling_redis/DemoServiceTest.java`
