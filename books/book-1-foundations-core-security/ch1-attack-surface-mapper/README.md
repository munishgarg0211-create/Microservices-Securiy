# ch1 - Expanded Threat Surface Mapper

- Book: book-1-foundations-core-security
- Chapter: ch1
- Status: scaffolded
- Suggested stack: OpenAPI, Graphviz

## Objective
Generate attack-surface map from APIs and service topology.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoService.java`
...
public class DemoService {
    ...
    private static final String CONCEPT = "Attack Surface Mapper";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_attack_surface_mapper/DemoServiceTest.java`
