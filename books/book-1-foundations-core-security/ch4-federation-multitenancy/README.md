# ch4 - Identity Federation and Multi-Tenancy

- Book: book-1-foundations-core-security
- Chapter: ch4
- Status: executable-demo
- Suggested stack: OIDC, Keycloak
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch4-federation-multitenancy";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Tenant-scoped claims and policy checks.";
    private static final String CONCEPT = "Federation Multitenancy";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch4-federation-multitenancy"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_federation_multitenancy/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch4-federation-multitenancy", result.get("project"));
