# ch3 - Transport Security Essentials

- Book: book-1-foundations-core-security
- Chapter: ch3
- Status: executable-demo
- Suggested stack: Spring Boot, cert-manager

## Objective
Establish mTLS between two services.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Establish mTLS between two services.";
    private static final String CONCEPT = "Mtls Baseline";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_mtls_baseline/DemoServiceTest.java`
