...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-geo-ip-rate-controls";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-geo-ip-rate-controls"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch5-geo-ip-rate-controls", result.get("project"));
