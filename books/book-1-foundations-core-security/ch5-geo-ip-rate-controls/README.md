...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_geo_ip_rate_controls/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch5-geo-ip-rate-controls",
                "book", "book-1-foundations-core-security",
                "status", "sample-ready",
