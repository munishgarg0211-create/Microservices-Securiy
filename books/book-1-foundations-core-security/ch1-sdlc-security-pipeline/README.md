# ch1 - Lifecycle Security Pipeline

- Book: book-1-foundations-core-security
- Chapter: ch1
- Status: executable-demo
- Suggested stack: GitHub Actions, Trivy, Semgrep

## Objective
Integrate security checks from build to runtime.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Integrate security checks from build to runtime.";
    private static final String CONCEPT = "Sdlc Security Pipeline";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch1_sdlc_security_pipeline/DemoServiceTest.java`
