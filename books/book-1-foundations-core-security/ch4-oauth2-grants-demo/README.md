# ch4 - OAuth2 Grant Types

- Book: book-1-foundations-core-security
- Chapter: ch4
- Status: executable-demo
- Suggested stack: Keycloak, Spring

## Objective
Compare client credentials and auth code flows.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoService.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_oauth2_grants_demo/DemoServiceTest.java`
