...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoServiceTest.java`: Automated check that validates expected secure behavior.
