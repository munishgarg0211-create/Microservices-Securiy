...
- Chapter: ch3
- Status: scaffolded
- Suggested stack: gRPC Java

## Objective
Secure gRPC with TLS and auth interceptors.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Secure gRPC with TLS and auth interceptors.";
    private static final String CONCEPT = "Grpc Tls Authz";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_grpc_tls_authz/DemoServiceTest.java`
