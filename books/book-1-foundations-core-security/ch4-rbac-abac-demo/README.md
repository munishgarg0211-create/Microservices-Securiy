...
- Suggested stack: Spring Authorization

## Objective
Implement role and attribute-based access checks.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch4-rbac-abac-demo";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Implement role and attribute-based access checks.";
    private static final String CONCEPT = "Rbac Abac Demo";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch4-rbac-abac-demo"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoServiceTest.java`
