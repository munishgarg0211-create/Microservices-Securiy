...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_rbac_abac_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior.
