# ch6 - Circuit Breaking for Fault Isolation
...
## Objective
Secure fallback modes with resilience patterns.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Secure fallback modes with resilience patterns.";
    private static final String CONCEPT = "Circuit Breaker Security";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_circuit_breaker_security/DemoServiceTest.java`
