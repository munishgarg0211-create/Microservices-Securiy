# ch2 - Breach Replay Mini Simulation

- Book: book-1-foundations-core-security
- Chapter: ch2
- Status: executable-demo
- Suggested stack: Mock CI, signatures

## Objective
Safe simulation of dependency/pipeline compromise controls.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Safe simulation of dependency/pipeline compromise controls.";
    private static final String CONCEPT = "Supply Chain Mini Sim";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch2_supply_chain_mini_sim/DemoServiceTest.java`
