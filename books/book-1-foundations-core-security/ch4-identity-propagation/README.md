# ch4 - Identity in Distributed Calls
...
## Objective
Propagate user identity across services securely.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch4-identity-propagation";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Propagate user identity across services securely.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch4-identity-propagation"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch4_identity_propagation/DemoServiceTest.java`
