# ch6 - Quota Algorithm Simulator

- Book: book-1-foundations-core-security
- Chapter: ch6
- Status: executable-demo
- Suggested stack: Node/Python

## Objective
Token bucket vs leaky bucket simulation.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "Token bucket vs leaky bucket simulation.";
    private static final String CONCEPT = "Rate Algorithms Simulator";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch6_rate_algorithms_simulator/DemoServiceTest.java`
