# ch5 - Edge Audit and Observability
...
## Objective
403 dashboards and correlation IDs at edge.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-edge-observability";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "403 dashboards and correlation IDs at edge.";
    private static final String CONCEPT = "Edge Observability";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-edge-observability"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch5-edge-observability", result.get("project"));
