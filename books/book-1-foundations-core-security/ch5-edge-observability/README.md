...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_edge_observability/DemoServiceTest.java`: Automated check that validates expected secure behavior.
...
public class DemoService {
    public Map<String, String> demo() {
        return Map.of(
                "project", "ch5-edge-observability",
                "book", "book-1-foundations-core-security",
                "status", "sample-ready",
