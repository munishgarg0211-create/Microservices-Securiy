...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoControllerTest.java`: Automated check that validates expected secure behavior.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoServiceTest.java`: Automated check that validates expected secure behavior.
