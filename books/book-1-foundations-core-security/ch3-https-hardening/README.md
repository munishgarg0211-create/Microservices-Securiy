...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "TLS cert rotation and HTTPS-only behavior.";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_https_hardening/DemoServiceTest.java`
