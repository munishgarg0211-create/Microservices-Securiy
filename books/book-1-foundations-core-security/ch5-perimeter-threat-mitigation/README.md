# ch5 - Perimeter Threat Prevention

- Book: book-1-foundations-core-security
- Chapter: ch5
- Status: executable-demo
- Suggested stack: Gateway filters

## Objective
Bot and credential stuffing mitigation pipeline.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-perimeter-threat-mitigation";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Bot and credential stuffing mitigation pipeline.";
    private static final String CONCEPT = "Perimeter Threat Mitigation";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-perimeter-threat-mitigation"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_perimeter_threat_mitigation/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch5-perimeter-threat-mitigation", result.get("project"));
