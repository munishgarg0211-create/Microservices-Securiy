# ch5 - IdP Integration Patterns

- Book: book-1-foundations-core-security
- Chapter: ch5
- Status: executable-demo
- Suggested stack: Keycloak, Gateway

## Objective
Token relay and phantom token patterns.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-idp-integration-patterns";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Token relay and phantom token patterns.";
    private static final String CONCEPT = "Idp Integration Patterns";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-idp-integration-patterns"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_idp_integration_patterns/DemoServiceTest.java`
