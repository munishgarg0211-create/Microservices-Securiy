# ch5 - Gateway as Security Control

- Book: book-1-foundations-core-security
- Chapter: ch5
- Status: executable-demo
- Suggested stack: Spring Cloud Gateway

## Objective
Show direct-service vs gateway-controlled paths.
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoService.java`
...
public class DemoService {
    ...
    private static final String PROJECT = "ch5-gateway-role-demo";
    private static final String BOOK = "book-1-foundations-core-security";
    private static final String OBJECTIVE = "Show direct-service vs gateway-controlled paths.";
    private static final String CONCEPT = "Gateway Role Demo";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoControllerTest.java`
...
class DemoControllerTest {
    ...
    void shouldServeSecureDemoPayload() throws Exception {
        mockMvc.perform(get("/api/demo"))
                ...
                .andExpect(jsonPath("$.project").value("ch5-gateway-role-demo"))
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch5_gateway_role_demo/DemoServiceTest.java`
...
class DemoServiceTest {
    ...
    void shouldReturnProjectMetadataAndSecureDefaults() {
        ...
        assertEquals("ch5-gateway-role-demo", result.get("project"));
