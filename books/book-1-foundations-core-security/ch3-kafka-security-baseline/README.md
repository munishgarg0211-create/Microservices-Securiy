# ch3 - Kafka Message Security

- Book: book-1-foundations-core-security
- Chapter: ch3
- Status: executable-demo
- Suggested stack: Kafka, Docker Compose
...
<!-- CODE_MAP_START -->
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoApplication.java`: Spring Boot entrypoint that starts this chapter demo.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoController.java`: API layer where request validation/authorization behavior is demonstrated.
- `src/main/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoService.java`: Service logic that implements the chapter's security control.
...
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoControllerTest.java`: Automated check that validates expected secure behavior and impact.
- `src/test/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoServiceTest.java`: Automated check that validates expected secure behavior and impact.

- **Highlight:** Core concept and impact tests below are pulled from the chapter implementation.

### Core Concept Code

- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoController.java`
...
- Source: `src/main/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoService.java`
...
public class DemoService {
    ...
    private static final String OBJECTIVE = "SASL/SCRAM + ACL + TLS producer/consumer.";
    private static final String CONCEPT = "Kafka Security Baseline";
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoControllerTest.java`
...
- Source: `src/test/java/com/munishgarg/microsecurity/book1/ch3_kafka_security_baseline/DemoServiceTest.java`
